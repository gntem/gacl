...
func UserGetByID(db *gorm.DB) func(*gin.Context) {
...
func UsersGetAll(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
...
func UserCreate(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
...
func UserDeleteByID(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
		userIDArg := ctx.Param("userID")
		...
		dbError := db.Delete(&models.User{ID: userID})
...
func UserUpdateByID(db *gorm.DB) func(*gin.Context) {
	return func(ctx *gin.Context) {
		userIDArg := ctx.Param("userID")
		...
		dbError := db.Model(&models.User{ID: userID}).Updates(&models.User{Name: rUserUpdate.Name})
